...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* Global Components */
        .btn, .btn-primary, .btn-secondary, .btn-info, .btn-warning, .btn-danger {
        ...
        .btn:hover, .btn-primary:hover, .btn-secondary:hover, .btn-info:hover, .btn-warning:hover, .btn-danger:hover {
            transform: translateY(-1px) !important;
            filter: brightness(1.05) !important;
        }

        .form-control, .form-select, .form-control-dark, .form-control-lg, .form-control-sm {
        ...
        .card-body, .card-modern > .card-body, .card-modern > .card-header {
        ...
        .table td, .table th, .table-modern td, .table-modern th {
...
<body class="@yield('body-class')">
    ...
    <main class="container-lg py-4 py-sm-5 app-main">
        @yield('content')
    </main>
