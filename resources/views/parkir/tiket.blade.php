    ...
    <div style="background: linear-gradient(145deg, #1a1a2e 0%, #16213e 100%); border-radius: 20px; overflow: hidden; box-shadow: 0 25px 50px rgba(0, 0, 0, 0.4), 0 0 0 1px rgba(255,255,255,0.05); position: relative;">
        ...
        <div style="padding: 28px;">
            ...
            <div style="margin-bottom: 24px; padding: 20px; background: rgba(99,102,241,0.1); border-radius: 14px; border-left: 4px solid #818cf8; position: relative; overflow: hidden;">
                ...
                <p style="margin: 0; font-size: 15px; font-weight: 600; color: rgba(255,255,255,0.8);">{{ $parkir->waktu_masuk->format('d M Y') }}</p>
                <p style="margin: 6px 0 0 0; font-size: 26px; font-weight: 700; color: #818cf8;">{{ $parkir->waktu_masuk->format('H:i:s') }}</p>
            </div>
...
<style>
    ...
    @media print {
        ...
        div[style*="background: linear-gradient(135deg, #11998e"] {
            background: linear-gradient(135deg, #00a86b 0%, #00c853 100%) !important;
        ...
        /* Check In Time - Blue background */
        div[style*="background: rgba(99,102,241,0.1)"] {
            background: #e3f2fd !important;
            border-left: 4px solid #1976d2 !important;
        }
        
        /* Time color - Make it darker blue */
        ...
        /* Instructions text */
        p[style*="text-align: center"][style*="color: rgba(255,255,255,0.6)"] {
        ...
        /* All text elements - ensure readability */
        p, span, div {
